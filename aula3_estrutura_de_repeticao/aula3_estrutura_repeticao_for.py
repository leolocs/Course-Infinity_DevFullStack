...
# # #Exibe o Alfabeto retirando as vogais do alfabeto
...
# Solicita uma frase ao usuário e se tiver números na frase mostre na tela 
...
# #Função range contagem de 0 a 9
# for i in range(10):
#      print(i)

# # função range do 1 até número 19
# for i in range(1,20):
#      print(i)

# Função range contagem de 1 a 100 com intervalo de 2 numeros
