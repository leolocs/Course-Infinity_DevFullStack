...
#region - Q7: Faça um Programa que leia três números e mostre o maior e o menor deles.
# num1 = int(input("Digite um número: "))
# num2 = int(input("Digite um segundo número: "))
# num3 = int(input("Digite um terceiro número: "))
# maior = num1
...
#region - Q.8: Faça um programa que pergunte o preço de três produtos e informe qual produto você deve comprar, sabendo que a decisão é sempre pelo mais barato.
...
#region - Q.9: Faça um Programa que leia três números e mostre-os em ordem decrescente.
...
#region - Q.10: Faça um Programa que pergunte em que turno você estuda. Peça para digitar M-matutino ou V-Vespertino ou N- Noturno. Imprima a mensagem "Bom Dia!", "Boa Tarde!" ou "Boa Noite!" ou "Valor Inválido!", conforme o caso.
